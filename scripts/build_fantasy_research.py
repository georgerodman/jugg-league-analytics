...
PROMPT_VERSION="fantasy-player-synthesis-v13-format-silent"
...
def player_context(player_id,profiles,targets,team_targets,handcuffs,fantasypros,format_notes,auction):
    ...
    if team in SCHEDULE and position in ("QB","RB","WR","TE"):
        ...
        if rating is not None:
            ...
            facts.append({"type":"schedule","text":f"The preseason forecast rates the team's 2026 regular-season {position} schedule {rating}/5 ({meaning}); 5 is friendliest and 1 is hardest. This is not the exhibition-game schedule. Treat the projected regular-season matchup difficulty as a modest tiebreaker, not a primary projection."})
